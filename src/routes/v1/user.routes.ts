...
userRouter.post('/change-password', adminAuthMiddleware, validateRequestBody(UserValidator.userPasswordChangeSchema), UserController.changePassword);
...
userRouter.get('/profile', adminAuthMiddleware, UserController.getUserProfile);
